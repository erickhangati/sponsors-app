...
// Form schema for adding a sponsor
export const sponsorFormSchema = z.object({
  ...
  // Role is fixed as "sponsor" for this form
});

// Form schema for editing a sponsor (password is optional)
...
export type SponsorEditValues = z.infer<typeof sponsorEditSchema>;
